...
void getRoom(string roomName, Room *room)
{   double holder;
    cout << "What is the length of the " << roomName << "? ";  //prompt the user to enter the room length
    cin >> holder;                                               //store the length in the holder variable
    room->setLength(holder);                                  //store the length into the class variable for length
    cout << "What is the width of the " <<roomName << "?";       //prompt the user to enter the bedroom width
    cin >> holder;                                               //store the length in the holder variable
    room->setWidth(holder);                                   //store the length into the class variable for width
}
